...
const appCss = "/assets/styles-DpzdCeCx.css";
...
const Route$3 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Blue Butterflies — Wear Your Transformation" },
      { name: "description", content: "Handcrafted butterfly jewellery — rings, bracelets, earrings and chains. Wear your transformation." },
      { name: "author", content: "Blue Butterflies" },
      { property: "og:title", content: "Blue Butterflies — Wear Your Transformation" },
      { property: "og:description", content: "Handcrafted butterfly jewellery — rings, bracelets, earrings and chains. Wear your transformation." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Blue Butterflies — Wear Your Transformation" },
      { name: "twitter:description", content: "Handcrafted butterfly jewellery — rings, bracelets, earrings and chains. Wear your transformation." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1047db73-2ea9-4502-9e47-22b16224d265/id-preview-bd52179f--e1efa4da-f66a-41fd-a0ed-3a4df4c2bc50.lovable.app-1779805890319.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1047db73-2ea9-4502-9e47-22b16224d265/id-preview-bd52179f--e1efa4da-f66a-41fd-a0ed-3a4df4c2bc50.lovable.app-1779805890319.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter$2 = () => import("./shop-C2bKn2ej.js");
const Route$2 = createFileRoute("/shop")({
  head: () => ({
    meta: [{
      title: "Shop · Blue Butterflies"
    }, {
      name: "description",
      content: "Browse rings, bracelets, earrings and chains — handcrafted butterfly jewellery."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-BzRacN9L.js");
const Route$1 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const rings = "/assets/cat-rings-D7gE-VJC.jpg";
const bracelets = "/assets/cat-bracelets-Bh74hloJ.jpg";
const earrings = "/assets/cat-earrings-jw50XmC_.jpg";
const chains = "/assets/cat-chains-Dsa6-khV.jpg";
const categories = [
...
const $$splitComponentImporter = () => import("./shop._category-BkuIUykL.js");
const $$splitErrorComponentImporter = () => import("./shop._category-hgJ35kYl.js");
const $$splitNotFoundComponentImporter = () => import("./shop._category-CiNwLtrI.js");
const Route2 = createFileRoute("/shop/$category")({
  loader: ({
    params
  }) => {
  ...
  head: ({
    ...
    meta: [{
      ...
      name: "description",
      content: loaderData?.cat.story ?? "Blue Butterflies jewellery."
    }]
  }),
...
const ShopRoute = Route$2.update({
  id: "/shop",
  path: "/shop",
...
const ShopCategoryRoute = Route2.update({
  id: "/$category",
  path: "/$category",
